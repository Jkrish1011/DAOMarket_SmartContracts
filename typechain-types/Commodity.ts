...
export interface CommodityInterface extends utils.Interface {
...
export interface Commodity extends BaseContract {
  contractName: "Commodity";
  ...
  callStatic: {
    ...
    update(newValue: BigNumberish, overrides?: CallOverrides): Promise<void>;
  };
